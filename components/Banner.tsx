...
function Banner() {
    ...
    return (
        <div className='flex min-h-screen flex-col-reverse items-center justify-around px-12 pb-36 lg:flex-row lg:pb-12 2xl:px-0'>
            ...
            <div className='flex basis-1/2 items-center justify-center lg:pb-32 lg:pl-16 lg:pr-16'>
                <div className='relative h-[32rem] w-[32rem] 2xl:h-[52rem] 2xl:w-[60rem]'>
                    <Image fill alt='banner' object-fit='contain' src={theme === 'light' ? '/banner.svg' : '/banner-dark.svg'} />
                </div>
            </div>
        </div>
    );
